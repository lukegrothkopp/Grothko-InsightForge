...
if page == "Dashboard":
    ...
    if st.session_state.data_loaded:
        ...
        3. Upload your data (current structure accepts **CSV** files uploaded under **"Data Upload"** in the left navigation, but can be built to tap live/internal systems)
             - **CRM:** Salesforce, HubSpot, Dynamics (accounts, opps, pipeline, activities)
             - **Ticketing/Events:** Ticketmaster/Archtics, Eventbrite, AudienceView, Tessitura; access/attendance scans.
